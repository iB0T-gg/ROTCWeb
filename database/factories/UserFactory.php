...
class UserFactory extends Factory
{
    ...
    public function definition(): array
    {
        return [
            ...
            'year' => fake()->randomElement(['1G', '2G', '3G', '4G', '1H', '2H', '3H', '4H']),
            'course' => fake()->randomElement(['BSIT', 'BSIS', 'BSCS', 'BSA', 'BSBA', 'BSED', 'BEED', 'BSN', 'BSHM', 'BSTM']),
            'section' => fake()->randomElement(['G1', 'G2']),
