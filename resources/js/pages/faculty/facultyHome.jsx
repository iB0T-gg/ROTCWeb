      ...
      <div className='flex flex-col md:flex-row'>
        ...
        <div className='flex-1 p-4 md:p-6'>
          <div className='font-regular'>
            {/* Breadcrumb */}
            <div className='bg-white p-2 md:p-3 text-[#6B6A6A] rounded-lg pl-4 md:pl-5 shadow-sm'>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              <a href="/faculty/facultyMerits">
                <div className="bg-white p-5 md:p-6 rounded-lg drop-shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
                  ...
                  <p className="text-gray-600 text-sm md:text-base">Manage and review merits</p>
                </div>
              </a>
              ...
              <a href="/faculty/facultyFinalGrades" className="sm:col-span-2 lg:col-span-1">
                <div className="bg-white p-5 md:p-6 rounded-lg drop-shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer">
