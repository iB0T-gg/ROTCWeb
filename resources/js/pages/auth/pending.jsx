        ...
        <>
            ...
            <div className='container mx-auto flex flex-col items-center justify-center h-full z-10 relative'>
                <div className='w-full max-w-[30rem] bg-black bg-opacity-80 text-textColor p-4 sm:p-8 rounded-xl sm:rounded-2xl shadow-lg animate-scale-in-up'>
                    ...
                    <h1 className='text-base sm:text-lg font-semibold mb-4 sm:mb-6 text-center animate-fade-in-up animate-stagger-2'>Account Activation Pending</h1>
                    <p className='text-xs sm:text-sm text-center mb-3 sm:mb-4 animate-fade-in-up animate-stagger-3'>
                        Your account is currently pending. To gain access, please visit the DMST office to register your fingerprint.
                    </p>
                    <p className='text-xs sm:text-sm text-center mb-3 sm:mb-4 animate-fade-in-up animate-stagger-4'>
