            ...
            <div className='flex flex-col md:flex-row'>
                ...
                <div className='flex-1 p-4 md:p-6 w-full'>
                    <div className='font-regular animate-fade-in-up'>
                        ...
                        <div className='flex items-center justify-between mt-4 mb-6 px-4 md:pl-5 py-5 md:py-7 bg-primary text-white rounded-lg shadow-md animate-fade-in-down'>
                            <h1 className='text-xl md:text-2xl font-semibold'>Welcome {auth.user.first_name}!</h1>
                        </div>

                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
                            <Link href="/user/userProfile">
                                <div className="bg-white p-5 md:p-6 rounded-lg drop-shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer animate-fade-in-up animate-stagger-1">
                            ...
                            <Link href="/user/userAttendance">
                                <div className="bg-white p-5 md:p-6 rounded-lg drop-shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer animate-fade-in-up animate-stagger-2">
                            ...
                            <Link href="/user/userGrades" className="sm:col-span-2 lg:col-span-1">
                                <div className="bg-white p-5 md:p-6 rounded-lg drop-shadow-lg hover:scale-105 transition-all duration-300 cursor-pointer animate-fade-in-up animate-stagger-3">
