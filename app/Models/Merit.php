...
class Merit extends Model
{
    ...
    // Get all week scores as array (first semester now has 15 weeks)
    ...
    // Set all week scores from array (first semester now has 15 weeks)
    ...
    // Get all demerits week scores as array (first semester now has 15 weeks)
    ...
    // Set all demerits week scores from array (first semester now has 15 weeks)
